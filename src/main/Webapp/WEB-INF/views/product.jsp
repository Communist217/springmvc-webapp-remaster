        ...
        <div style="display: table; margin: auto;">
            ...
            <section class="Right_Content">
                ...
                <div style="padding-bottom: 50px;">
                    ...
                    <div>
                        <c:forEach items="${Product_Description.rows}" var="Des">
                            <c:forTokens items="${Des.Description}" delims="=" var="System_Description">
                                <p style="margin-left: 10px;"> - <c:out value="${System_Description}"></c:out></p>
                            </c:forTokens>
                        </c:forEach>
                    </div>
                    ...
                    <c:forEach items="${Product_Warranty.rows}" var="Warr">
                        <p style="margin-left: 10px;"> - <c:out value="${Warr.Warranty}">N/A</c:out></p>
                    </c:forEach>
                ...
                <section id="Comment">
                        ...
                        <c:forEach items="${ProgressBar}" var="entry">
                            <%--<c:if test="${entry.key == 'Positive'}">
                                ...
                                <div class="progress" style="height: 20px;">
                                    <div class="progress-bar bg-success" style="width:20%">Positive</div>
                                </div><br>
                            </c:if>
                            <c:if test="${entry.key == 'Mixed'}">
                                <!-- Mixed -->
                                <div class="progress" style="height: 20px;">
                                    <div class="progress-bar bg-warning" style="width:40%">Mixed</div>
                                </div><br>
                            </c:if>
                            <c:if test="${entry.key == 'Negative'}">
                                <!-- Negative -->
                                <div class="progress" style="height: 20px;">
                                    <div class="progress-bar bg-danger" style="width:50%;">Negative</div>
                                </div><br>
                            </c:if>--%>
                                    ...
                                    <li>
                                        ...
                                        <div class="Reviews">
                                            ...
                                            <a href="javascript:Reply_Button_Toggle('${comment.PostID}');" style="text-decoration: none; color: #007bff;">
                                                <img id="Reply-button" src="Style/IMG/reply-icon.png" style="max-width: 22px; max-height: 22px;" title="Reply"> <%--(<p style="display: inline;" id="CountReply<c:out value="${comment.PostID}"/>">)</p>--%>
                                            </a>
                                            <form class="Like_Submit" style="display: inline;">
                                                ...
                                                <c:if test="${not empty User.getUserID()}">
                                                    ...
                                                    <c:if test="${Like_count.rowCount == 0}">
                                                        <a class="like_click<c:out value="${comment.PostID}"/>" href="javascript:Like_ReviewPost('${comment.PostID}', '${UserID}');" style="margin-left: 8px; text-decoration: none;">
                                                            <img id="Like<c:out value="${comment.PostID}"/>" src="Style/IMG/like-button.png" style="max-width: 22px; max-height: 22px; margin-top: -3px;" title="Like" alt="#"> <%--(<p style="display: inline;" id="CountReply<c:out value="${comment.PostID}"/>">)</p>--%>
                                                        </a>
                    ...
                    <c:if test="${Review.rowCount == 0}">
                        <p style="margin-top: 9px; opacity: 0.6;">There haven't been a review yet, you are the first user to write your review about ${Name}.</p>
                    </c:if>
                </section>
            </section>
        </div>
